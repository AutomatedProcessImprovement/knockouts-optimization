...
class StateBasedBucketer(object):
    ...
    def predict(self, X, y=None):
        ...
        print(self.dt_states.columns.values)
        print(dt_encoded.columns.values)
        
        dt_transformed = pd.merge(dt_encoded, self.dt_states, how='left', on=dt_encoded.columns.values)
