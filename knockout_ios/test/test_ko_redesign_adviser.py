...
def test_ko_reorder_io_simple():
    ...
    assert adviser.redesign_options['reordering']['optimal_ko_order'] == ["Check Monthly Income", "Check Risk",
...
def test_ko_reorder_io_advanced():
    ...
    assert adviser.redesign_options['reordering']['optimal_ko_order'] == ["Check Liability", "Check Risk",
