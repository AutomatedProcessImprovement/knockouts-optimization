...
from variability_analysis.preprocessing import LogReader
from variability_analysis.preprocessing.external.feature_extraction import intercase_and_context
...
def preprocess(config_file, config_dir="pipeline_config", cache_dir="./cache/", add_intercase_and_context=True,
