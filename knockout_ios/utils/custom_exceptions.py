class KnockoutMetricsException(Exception):
    pass


class LogNotLoadedException(Exception):
    pass
...
class EmptyKnockoutActivitiesException(Exception):
    pass


class KnockoutsDiscoveryException(Exception):
    pass
